...
function submit() {
  ...
  if (input1.value.length < 8 || input1.value.length === null) {
    alert(" user name Should min 8 character length");
  } else if (input2.value.length < 8 || input2.value.length === null) {
    alert(" user password Should min 8 character length");
...
function submitLogin() {
  ...
  if (inputLogin.value.length < 8 || inputLogin.value.length === null) {
    alert(" user name Should min 8 character length");
  } else if (
    inputLogin2.value.length < 8 ||
